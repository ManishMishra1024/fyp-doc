...
<body>
    ...
    ?>
    <!-- creating user's (doctor) profile -->
    <div class="container">
        <div class="menu">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <!-- CRUD operartion for displaying appointment details -->
                <?php
    ...
    <!-- if else for action events (add, drop & view) -->
    <?php
    if($_GET){
        $id=$_GET["id"];
        $action=$_GET["action"];
        // action event for add event
