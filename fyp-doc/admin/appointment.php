...
<body>
    ...
    ?>
    <!-- creating the admins profile section and sidebar menu using template -->
    <div class="container">
        <div class="menu">
    ...
    <!-- coping previous code to perform cancel appointment action -->
    <?php
    if($_GET){
        $id=$_GET["id"];
        $action=$_GET["action"];
