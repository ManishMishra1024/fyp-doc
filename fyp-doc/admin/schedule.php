...
<body>
    ...
    <div class="container">
        ...
        <!-- creating the topbar using template -->
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon" ;"> Add a Session</font></button>
                        </a>
                        </div>
                    </td>
                </tr>
                ...
                <!-- creating table for displaying data from schedule table (CRUD operation)  -->
                <?php
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
...
<!-- working on the events button actions -->
<?php
    if($_GET){
        $id=$_GET["id"];
        $action=$_GET["action"];
        // action for add new sessions
        if($action=='add-session'){
            ...
            ';
            // action for successful scheduling
            ...
            ';
            // action for removing a schedule
        }elseif($action=='drop'){
            $nameget=$_GET["name"];
            echo '
            <div id="popup1" class="overlay">
            ...
            '; 
            // action for viewing the scheduled details
        }elseif($action=='view'){
                                ...
                                <center>
                                 ...
                                 <tbody>';
                                         ...
                                         if($result->num_rows==0){
                                             ...
                                             <br><br><br><br>
                                             <center>
                                             <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">We  couldnt find anything related to show!</p>
