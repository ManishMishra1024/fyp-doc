...
// implementing user authentication and session management
    ...
    ?>
   <!-- creating a container class for admin's profile section -->
   <div class="container">
        <div class="menu">
        ...
        <!-- creating the sidebar menu for admin page -->
                <tr class="menu-row" >
                    <td>
        ...
        <!-- creating a search box and today's date -->
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
               ...
               <!-- add new doctor into the system -->
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Add New Doctor</p>
                    </td>
                    <td colspan="2">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="display: flex;justify-content: center;align-items: center;margin-left:75px;">Add Doctor</font></button>
                            </a></td>
                </tr>
                <tr>
                ...
                ?>
                  <!-- displaying data from doctors table (crud operation) -->
                  <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                // assigning the result of a database query to a variable named result
                                $result= $database->query($sqlmain);

                                // checking if the database query executed successfully and returned any rows
                                if($result->num_rows==0){
                                    ...
                                    <center>                                    
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">We  couldnt find anything related!</p>
                                ...
                                // displaying data from a MySQL database in table form(CRUD operation for doctors table inside admin page).
                                else{
    ...
    <?php 
    // checking if the superglobal variable is set or not
    if($_GET){
        $id=$_GET["id"];
        $action=$_GET["action"];
        // working on the events button (Remove)
        if($action=='drop'){
            $nameget=$_GET["name"];
            echo '
            ...
            ';
            // code for events button (Add New Doctors)
        }elseif($action=='add'){
                $error_1=$_GET["error"];
                $errorlist= array(
