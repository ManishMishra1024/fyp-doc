    ...
    if ($newpassword == $cpassword) {
        ...
        if ($result->num_rows == 1) {
            ...
            if (!$email) {
                ...
                $database->query("insert into patient(pemail,pname,ppassword, paddress, pdob,ptel) values('$email','$name','$hashed_password','$address', '$dob','$tele');");
...
?>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="tel" name="tele" class="input-text"  placeholder="ex: 9812345600"  >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
